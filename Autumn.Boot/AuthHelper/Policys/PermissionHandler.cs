...
namespace Autumn.AuthHelper
{
    ...
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        /// services 层注入
        /// </summary>
        public IPermissionService roleModulePermissionServices { get; set; }
        ...
        public PermissionHandler(IAuthenticationSchemeProvider schemes, IPermissionService roleModulePermissionServices)
        {
            Schemes = schemes;
