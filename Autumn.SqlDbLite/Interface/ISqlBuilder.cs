...
namespace SqlDbLite
{
    public partial interface ISqlBuilder
    {
        ...
        void RepairReplicationParameters(ref string appendSql, DbLiteParameter[] parameters, int addIndex);
        KeyValuePair<string, DbLiteParameter[]> ConditionalModelToSql(List<IConditionalModel> models, int beginIndex = 0);
    }
}
