...
namespace SqlDbLite
{
    ...
    public partial class IDataReaderEntityBuilder<T>
    {
        ...
        #region Fields
        private SqlDbLiteProvider Context = null;
        ...
        private static readonly MethodInfo getEntity = typeof(IDataRecordExtensions).GetMethod("GetEntity", new Type[] { typeof(SqlDbLiteProvider) });
        ...
        {
            DynamicMethod method = new DynamicMethod("SqlDbLiteEntity", type,
        ...
        private void CheckType(List<string> invalidTypes, string bindProperyTypeName, string validPropertyType, string propertyName)
        {
            ...
            if (isAny)
            {
                throw new SqlDbLiteException(string.Format("{0} can't  convert {1} to {2}", propertyName, validPropertyType, bindProperyTypeName));
            }
        }
        #endregion
    }
