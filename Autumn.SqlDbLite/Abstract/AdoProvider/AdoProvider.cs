...
namespace SqlDbLite
{
    ...
    public abstract partial class AdoProvider : AdoAccessory, IAdo
    {
        ...
        public virtual SqlDbLiteProvider Context { get; set; }
        ...
        public virtual Action<string, DbLiteParameter[]> LogEventStarting => this.Context.CurrentConnectionConfig.AopEvents?.OnLogExecuting;
        public virtual Action<string, DbLiteParameter[]> LogEventCompleted => this.Context.CurrentConnectionConfig.AopEvents?.OnLogExecuted;
        public virtual Func<string, DbLiteParameter[], KeyValuePair<string, DbLiteParameter[]>> ProcessingEventStartingSQL => this.Context.CurrentConnectionConfig.AopEvents?.OnExecutingChangeSql;
        protected virtual Func<string, string> FormatSql { get; set; }
        public virtual Action<SqlDbLiteException> ErrorEvent => this.Context.CurrentConnectionConfig.AopEvents?.OnError;
        ...
        #region abstract
        public abstract IDataParameter[] ToIDbDataParameter(params DbLiteParameter[] pars);
        public abstract void SetCommandToAdapter(IDataAdapter adapter, DbCommand command);
        public abstract IDataAdapter GetAdapter();
        public abstract DbCommand GetCommand(string sql, DbLiteParameter[] pars);
        ...
        #region Core
        public virtual int ExecuteCommand(string sql, params DbLiteParameter[] parameters)
        {
            try
            {
        ...
        public virtual IDataReader GetDataReader(string sql, params DbLiteParameter[] parameters)
        {
            try
            {
                InitParameters(ref sql, parameters);
        ...
        public virtual DataSet GetDataSetAll(string sql, params DbLiteParameter[] parameters)
        {
            try
            {
                InitParameters(ref sql, parameters);
        ...
        public virtual object GetScalar(string sql, params DbLiteParameter[] parameters)
        {
            try
            {
                InitParameters(ref sql, parameters);
        ...
        public virtual async Task<int> ExecuteCommandAsync(string sql, params DbLiteParameter[] parameters)
        {
            try
            {
                Async();
        ...
        public virtual async Task<IDataReader> GetDataReaderAsync(string sql, params DbLiteParameter[] parameters)
        {
            try
            {
                Async();
        ...
        public virtual async Task<object> GetScalarAsync(string sql, params DbLiteParameter[] parameters)
        {
            try
            {
                Async();
        ...
        public virtual Task<DataSet> GetDataSetAllAsync(string sql, params DbLiteParameter[] parameters)
        {
            Async();
        ...
        public virtual string GetString(string sql, params DbLiteParameter[] parameters)
        {
            return Convert.ToString(GetScalar(sql, parameters));
        }
        public virtual string GetString(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual async Task<string> GetStringAsync(string sql, params DbLiteParameter[] parameters)
        {
            return Convert.ToString(await GetScalarAsync(sql, parameters));
        }
        public virtual Task<string> GetStringAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual int GetInt(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
                return GetInt(sql);
        ...
        public virtual int GetInt(string sql, params DbLiteParameter[] parameters)
        {
        ...
        public virtual Task<int> GetIntAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual async Task<int> GetIntAsync(string sql, params DbLiteParameter[] parameters)
        {
        ...
        public virtual Double GetDouble(string sql, params DbLiteParameter[] parameters)
        {
            return GetScalar(sql, parameters).ObjToMoney();
        }
        public virtual Double GetDouble(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual async Task<Double> GetDoubleAsync(string sql, params DbLiteParameter[] parameters)
        {
            var result = await GetScalarAsync(sql, parameters);
            return result.ObjToMoney();
        }
        public virtual Task<Double> GetDoubleAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual decimal GetDecimal(string sql, params DbLiteParameter[] parameters)
        {
            return GetScalar(sql, parameters).ObjToDecimal();
        }
        public virtual decimal GetDecimal(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual async Task<decimal> GetDecimalAsync(string sql, params DbLiteParameter[] parameters)
        {
            var result = await GetScalarAsync(sql, parameters);
            return result.ObjToDecimal();
        }
        public virtual Task<decimal> GetDecimalAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual DateTime GetDateTime(string sql, params DbLiteParameter[] parameters)
        {
            return GetScalar(sql, parameters).ObjToDate();
        }
        public virtual DateTime GetDateTime(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual async Task<DateTime> GetDateTimeAsync(string sql, params DbLiteParameter[] parameters)
        {
            var list = await GetScalarAsync(sql, parameters);
            return list.ObjToDate();
        }
        public virtual Task<DateTime> GetDateTimeAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        {
            var DbLiteParameters = this.GetParameters(parameters);
            return SqlQuery<T>(sql, DbLiteParameters);
        }
        public virtual List<T> SqlQuery<T>(string sql, params DbLiteParameter[] parameters)
        {
            var result = SqlQuery<T, object, object, object, object, object, object>(sql, parameters);
            return result.Item1;
        }
        public virtual List<T> SqlQuery<T>(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters != null)
            {
        ...
        {
            var DbLiteParameters = this.GetParameters(parameters);
            return SqlQueryAsync<T>(sql, DbLiteParameters);
        }
        public virtual async Task<List<T>> SqlQueryAsync<T>(string sql, params DbLiteParameter[] parameters)
        {
            var result = await SqlQueryAsync<T, object, object, object, object, object, object>(sql, parameters);
            return result.Item1;
        }
        public virtual Task<List<T>> SqlQueryAsync<T>(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters != null)
            {
        ...
        public virtual T SqlQuerySingle<T>(string sql, params DbLiteParameter[] parameters)
        {
            var result = SqlQuery<T>(sql, parameters);
            return result == null ? default(T) : result.FirstOrDefault();
        }
        public virtual T SqlQuerySingle<T>(string sql, List<DbLiteParameter> parameters)
        {
            var result = SqlQuery<T>(sql, parameters);
            return result == null ? default(T) : result.FirstOrDefault();
        }
        ...
        public virtual async Task<T> SqlQuerySingleAsync<T>(string sql, params DbLiteParameter[] parameters)
        {
            var result = await SqlQueryAsync<T>(sql, parameters);
            return result == null ? default(T) : result.FirstOrDefault();
        }
        public virtual async Task<T> SqlQuerySingleAsync<T>(string sql, List<DbLiteParameter> parameters)
        {
            var result = await SqlQueryAsync<T>(sql, parameters);
            return result == null ? default(T) : result.FirstOrDefault();
        }
        ...
        public virtual DataTable GetDataTable(string sql, params DbLiteParameter[] parameters)
        {
        ...
        public virtual DataTable GetDataTable(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual async Task<DataTable> GetDataTableAsync(string sql, params DbLiteParameter[] parameters)
        {
        ...
        public virtual Task<DataTable> GetDataTableAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual DataSet GetDataSetAll(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual Task<DataSet> GetDataSetAllAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual IDataReader GetDataReader(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual Task<IDataReader> GetDataReaderAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual object GetScalar(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual Task<object> GetScalarAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual int ExecuteCommand(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        public virtual Task<int> ExecuteCommandAsync(string sql, List<DbLiteParameter> parameters)
        {
            if (parameters == null)
            {
        ...
        private void ExecuteProcessingSQL(ref string sql, DbLiteParameter[] parameters)
        {
            var result = this.ProcessingEventStartingSQL(sql, parameters);
            sql = result.Key;
            parameters = result.Value;
        }
        public virtual void ExecuteBefore(string sql, DbLiteParameter[] parameters)
        {
            if (this.Context.CurrentConnectionConfig.Debugger != null && this.Context.CurrentConnectionConfig.Debugger.EnableThreadSecurityValidation == true)
            {
                ...
                else
                {
                    ...
                    {
                        throw new SqlDbLiteException(this.Context, ErrorMessage.GetThrowMessage("Detection of SqlDbLiteClient cross-threading usage,a thread needs a new one", "检测到声名的SqlDbLiteClient跨线程使用，请检查是否静态、是否单例、或者IOC配置错误引起的，保证一个线程new出一个对象 ，具本Sql:") + sql, parameters);
                    }
                }
            }
            ...
            {
                Action<string, DbLiteParameter[]> action = LogEventStarting;
                if (action != null)
                {
                    if (parameters == null || parameters.Length == 0)
                    {
                        action(sql, new DbLiteParameter[] { });
                    }
                    else
                    {
        ...
        public virtual void ExecuteAfter(string sql, DbLiteParameter[] parameters)
        {
            ...
            if (this.IsEnableLogEvent)
            {
                Action<string, DbLiteParameter[]> action = LogEventCompleted;
                if (action != null)
                {
                    if (parameters == null || parameters.Length == 0)
                    {
        ...
        public virtual DbLiteParameter[] GetParameters(object parameters, PropertyInfo[] propertyInfo = null)
        {
        ...
        private void ExecuteErrorEvent(string sql, DbLiteParameter[] parameters, Exception ex)
        {
            ErrorEvent(new SqlDbLiteException(this.Context, ex, sql, parameters));
        }
        private void InitParameters(ref string sql, DbLiteParameter[] parameters)
        {
        ...
        [Obsolete]
        public virtual dynamic SqlQueryDynamic(string sql, params DbLiteParameter[] parameters)
        {
            var dt = this.GetDataTable(sql, parameters);
            return dt == null ? null : this.Context.Utilities.DataTableToDynamic(dt);
        }
        [Obsolete]
        public dynamic SqlQueryDynamic(string sql, List<DbLiteParameter> parameters)
        {
            var dt = this.GetDataTable(sql, parameters);
            return dt == null ? null : this.Context.Utilities.DataTableToDynamic(dt);
        }
