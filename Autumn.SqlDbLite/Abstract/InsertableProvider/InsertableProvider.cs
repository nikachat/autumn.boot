...
namespace SqlDbLite
{
    public class InsertableProvider<T> : IInsertable<T> where T : class, new()
    {
        ...
        public virtual KeyValuePair<string, List<DbLiteParameter>> ToSql()
        {
            ...
            RestoreMapping();
            return new KeyValuePair<string, List<DbLiteParameter>>(sql, InsertBuilder.Parameters);
        }
        ...
        protected virtual void PreToSql()
        {
            ...
            if (this.IsSingle)
            {
                ...
                {
                    if (this.InsertBuilder.Parameters == null) this.InsertBuilder.Parameters = new List<DbLiteParameter>();
