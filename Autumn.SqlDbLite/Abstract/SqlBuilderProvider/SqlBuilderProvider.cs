...
namespace SqlDbLite
{
    public abstract partial class SqlBuilderProvider : SqlBuilderAccessory, ISqlBuilder
    {
        ...
        public virtual void RepairReplicationParameters(ref string appendSql, DbLiteParameter[] parameters, int addIndex)
        {
        ...
        {
            if (models.IsNullOrEmpty()) return new KeyValuePair<string, DbLiteParameter[]>();
