...
namespace SqlDbLite
{
    ...
    {
        public ISqlDbLiteClient Context { get; set; }
        ...
        public IDeleteable<T> Where(string whereString, object parameters = null)
        {
            ...
            if (parameters != null)
            {
                ...
                {
                    DeleteBuilder.Parameters = new List<DbLiteParameter>();
                }
        ...
        public IDeleteable<T> Where(string whereString, DbLiteParameter[] parameters)
        {
            DeleteBuilder.Parameters.AddRange(parameters);
            return this;
        }
        public IDeleteable<T> Where(string whereString, List<DbLiteParameter> parameters)
        {
            DeleteBuilder.Parameters.AddRange(parameters);
            return this;
        }
