...
namespace SqlDbLite
{
    public class ConnectionConfig
    {
        ...
        /// </summary>
        public DbLiteDebugger Debugger { get; set; }
    ...
    public class AopEvents
    {
        ...
        public Action<SqlDbLiteException> OnError { get; set; }
        public Action<string, DbLiteParameter[]> OnLogExecuting { get; set; }
        public Action<string, DbLiteParameter[]> OnLogExecuted { get; set; }
        public Func<string, DbLiteParameter[], KeyValuePair<string, DbLiteParameter[]>> OnExecutingChangeSql { get; set; }
    }
